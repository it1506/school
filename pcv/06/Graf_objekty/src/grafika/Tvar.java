...
public abstract class Tvar {
    ...
    public void setRychlost(int rychlost) {
        ...
        if (this.rychlost > 20) this.rychlost = 20;
        if (this.rychlost < -20) this.rychlost = -20;
    }
    ...
    public void presun(int dx, int dy){
        ...
        if (this.pozice.x < 0) this.pozice.x = panel.getWidth();
        if (this.pozice.y < 0) this.pozice.y = panel.getHeight();
    }
